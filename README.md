# Git Practice: Кошина Александра
...
| Поле             | Значение                                |
|------------------|-----------------------------------------|
| ФИО              | Кошина Александра Олеговна                          |
| Группа           | РПО 1/1                       |
...
2. Частичное заполнение README
3. Проверка налчиия git репозитория
4. Проверка структуры проекта
5. Настройка файла .gitignore
6. Проверка файла .gitignore
7. Cоздание первого коммита (по заданию, так уже было достаотчно комитов)
8. Изменение remote и публикация личного репозитория 
...
Fetch подргружает будущие изменения, которые были залиты на гит репозиторий без изменения локальных файлов, а pull загружает и добавляет изменения в локальные файлы
